...
<!-- 	        </div> -->
	        <div class="col-sm-4">
				...
				<br><br><a class="active" href="result.jsp"><button class="btn btn-secondary btn-sm float-right">Résultat</button></a> 
...
<section>
  <!--for demo wrap-->
  <h1>Centre de Dépouillement</h1><br>
    ...
    <table class="table" cellpadding="0" cellspacing="0" border="0">
      <%
				Gestiondb bd = new Gestiondb();
 				Collection<Vote> votes = bd.getAllVote();
 					for (Vote votant : votes) {
