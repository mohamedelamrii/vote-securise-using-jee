...
<!-- 	 		<div class="col-sm-12"> -->
<!-- 	       		<a class="active" href="index.jsp">Retour</a> -->
<!-- 	       	</div> -->
<!-- 	     </nav> -->
...
<!-- 				<img class="rounded" src="img/titre.png"> -->
	...
	<div class="row">
        <div class="col-sm-12">
<!--              <br><h2 class="text-center text-white" style="margin-bottom: 10%">Centre de Comptage</h2> -->
        </div>
    </div>
	...
	<div class="login-box">
	  <h2>Connexion</h2>
	  <form class="form-signin" method="post" action="loginServletCo">
	    <div class="user-box">
